...
<script>
    ...
    var MSP = function(json) {
        ...
        var skin = new Image();
        skin.src = "data:image/png;base64,<?= $skinBase64 ?>"
        ...
        var cape = new Image();
        <?php if($isCape){ ?>
            cape.src = "data:image/png;base64,<?= $capeBase64 ?>";
        <?php } ?>
